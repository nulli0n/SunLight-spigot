...
public class EcoTakeCommand extends AbstractCommand<SunLightEconomyPlugin> {
	...
	public EcoTakeCommand(@NotNull EconomyManager economyManager) {
		super(economyManager.plugin(), new String[] {"take"}, EconomyPerms.CMD_ECO_TAKE);
	...
	public String getUsage() {
		return this.plugin.getMessage(EconomyLang.Command_Eco_Take_Usage).getLocalized();
	}

	@Override
	@NotNull
	public String getDescription() {
		return this.plugin.getMessage(EconomyLang.Command_Eco_Take_Desc).getLocalized();
	}
	...
	public void onExecute(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args, @NotNull Map<String, String> flags) {
		...
		this.plugin.getMessage(EconomyLang.Command_Eco_Take_Done)
