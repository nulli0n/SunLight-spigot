...
public class ExtrasLang implements LangColors {
    ...
    public static final LangKey COMMAND_CHAIRS_TARGET = LangKey.of("Extras.Command.Chairs.Target", LIGHT_YELLOW + "Auto-Chairs " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SIT_TARGET = LangKey.of("Extras.Command.Sit.Target", LIGHT_YELLOW + "Made " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to sit.");
    ...
    public static final LangKey COMMAND_CHEST_SORT_TARGET = LangKey.of("Extras.Command.ChestSort.Target", LIGHT_YELLOW + "Chest Sort " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
