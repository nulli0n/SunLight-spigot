...
public class PlayerWarpsSearchDialog extends Dialog<WarpsListData> {
    ...
    private static final TextLocale TITLE = LangEntry.builder("PlayerWarps.Dialog.WarpSearch.Title").text(title("Player Warps", "Search"));

    private static final DialogElementLocale BODY = LangEntry.builder("PlayerWarps.Dialog.WarpSearch.Body").dialogElement(400,
        "Enter text to search."
    );

    private static final TextLocale INPUT_TEXT = LangEntry.builder("PlayerWarps.Dialog.WarpSearch.Input.Text").text("Search for");
