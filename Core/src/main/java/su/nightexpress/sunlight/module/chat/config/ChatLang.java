...
public class ChatLang {
    ...
    public static final LangKey ANTI_SPAM_SIMILAR_MSG = new LangKey("Chat.Chat.AntiSpam.Similar.Msg", NO_PREFIX + "&cDo not spam messages!");
    public static final LangKey ANTI_SPAM_SIMILAR_CMD = new LangKey("Chat.Chat.AntiSpam.Similar.Cmd", NO_PREFIX + "&cDo not spam commands!");
    public static final LangKey ANTI_SPAM_DELAY_MSG = new LangKey("Chat.Chat.AntiSpam.Delay.Msg", NO_PREFIX + "&cYou have to wait &c" + Placeholders.GENERIC_TIME + " &cbefore you can send another message.");
    public static final LangKey ANTI_SPAM_DELAY_CMD = new LangKey("Chat.Chat.AntiSpam.Delay.Cmd", NO_PREFIX + "&cYou have to wait &c" + Placeholders.GENERIC_TIME + " &cbefore you can use another command.");
    public static final LangKey MENTION_ERROR_COOLDOWN = LangKey.of("Chat.Chat.Mention.Error.Cooldown", NO_PREFIX + "&cYou can mention &e" + Placeholders.GENERIC_NAME + "&c again in &e%time%&c.");
    ...
    public static final LangKey COMMAND_MENTIONS_DESC = LangKey.of("Command.Mentions.Desc", "Toggle [player's] Mentions.");
    public static final LangKey COMMAND_MENTIONS_USAGE = LangKey.of("Command.Mentions.Usage", "[player] [-on] [-off] [-s]");
    public static final LangKey COMMAND_MENTIONS_TOGGLE_NOTIFY = LangKey.of("Command.Mentions.Toggle.Notify", LIGHT_YELLOW + "Your Mentions has been " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_MENTIONS_TOGGLE_TARGET = LangKey.of("Command.Mentions.Toggle.Target", LIGHT_YELLOW + "Set Mentions " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey CHANNEL_JOIN_ERROR_NO_PERMISSION = new LangKey("Chat.Channel.Join.Error.NoPermission", NO_PREFIX + "&cYou don't have permissions to join this channel.");
    public static final LangKey CHANNEL_JOIN_ERROR_ALREADY_IN = new LangKey("Chat.Channel.Join.Error.AlreadyIn", NO_PREFIX + "&cYou already joined this channel!");
    ...
    public static final LangKey CHANNEL_LEAVE_ERROR_NOT_IN = new LangKey("Chat.Channel.Leave.Error.NotIn", NO_PREFIX + "&cYou're are not in the channel!");
