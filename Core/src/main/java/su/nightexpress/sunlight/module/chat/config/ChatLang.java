...
public class ChatLang {
    ...
    public static final LangKey Chat_AntiSpam_Delay_Msg   = new LangKey("Chat.Chat.AntiSpam.Delay.Msg", "{message: ~prefix: false;}&cYou have to wait &c" + Placeholders.GENERIC_TIME + " &cbefore you can send another message.");
    public static final LangKey Chat_AntiSpam_Delay_Cmd   = new LangKey("Chat.Chat.AntiSpam.Delay.Cmd", "{message: ~prefix: false;}&cYou have to wait &c" + Placeholders.GENERIC_TIME + " &cbefore you can use another command.");
    public static final LangKey CHAT_MENTION_ERROR_COOLDOWN = LangKey.of("Chat.Chat.Mention.Error.Cooldown", "{message: ~prefix: false;}&cYou can mention &e" + Placeholders.GENERIC_NAME + "&c again in &e%time%&c.");
    ...
    public static final LangKey Channel_Join_Success            = new LangKey("Chat.Channel.Join.Success", "{message: ~prefix: false;}&7You joined the &a" + Placeholders.CHANNEL_NAME + " &7chat channel.");
    ...
    public static final LangKey Channel_Leave_Success           = new LangKey("Chat.Channel.Leave.Success", "{message: ~prefix: false;}&7You have left the &c" + Placeholders.CHANNEL_NAME + "&7 chat channel.");
    ...
    public static final LangKey Channel_Set_Success             = new LangKey("Chat.Channel.Set.Success", "{message: ~prefix: false;}&7Set default channel: &e" + Placeholders.CHANNEL_NAME + "&7.");
    ...
    public static final LangKey COMMAND_CLEAR_CHAT_DONE = new LangKey("Chat.Command.ClearChat.Done", "{message: ~prefix: false;}&7Chat has been cleared by &a" + Placeholders.Player.DISPLAY_NAME + "&7.");
    ...
    public static final LangKey COMMAND_REPLY_ERROR_EMPTY    = new LangKey("Chat.Command.Reply.Error.Empty", "{message: ~prefix: false;}&cYou have not received any private messages.");
    ...
    public static final LangKey COMMAND_SPY_MODE_DONE_OTHERS = new LangKey("Chat.Command.Spy.Mode.Done.Others", "Set &c" + Placeholders.GENERIC_TYPE + " &7Spy Mode for &c" + Placeholders.Player.NAME + " &7to &f" + Placeholders.GENERIC_STATE);
    ...
    public static final LangKey COMMAND_SPY_LOGGER_DONE      = new LangKey("Chat.Command.Spy.Logger.Done.Add", "Set &c" + Placeholders.GENERIC_TYPE + " &7Spy Logger for &c" + Placeholders.Player.NAME + " &7to &f" + Placeholders.GENERIC_STATE);
