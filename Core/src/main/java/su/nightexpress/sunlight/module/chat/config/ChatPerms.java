...
public class ChatPerms {
    ...
    public static final JPermission COMMAND_MENTIONS         = new JPermission(PREFIX_COMMAND + MentionsCommand.NAME, "Access to the 'mentions' command.");
    public static final JPermission COMMAND_MENTIONS_OTHERS  = new JPermission(PREFIX_COMMAND + MentionsCommand.NAME + ".others", "Access to the 'mentions' command on other players.");
    ...
    public static final JPermission COMMAND_TOGGLE_PM        = new JPermission(PREFIX_COMMAND + TogglePMCommand.NAME, "Access to the 'togglepm' command.");
    public static final JPermission COMMAND_TOGGLE_PM_OTHERS = new JPermission(PREFIX_COMMAND + TogglePMCommand.NAME + ".others", "Access to the 'togglepm' command on other players.");
    ...
    static {
        ...
        CHAT_COMMAND.addChildren(
            COMMAND_CHATCHANNEL,
            COMMAND_ME,
            COMMAND_MENTIONS, COMMAND_MENTIONS_OTHERS,
            COMMAND_REPLY, COMMAND_TELL,
            COMMAND_SPY, COMMAND_SPY_MODE, COMMAND_SPY_MODE_OTHERS, COMMAND_SPY_LOGGER,
            COMMAND_CLEARCHAT,
