...
public class BansLang {
    ...
    public static final LangKey PUNISHMENT_ERROR_RANK_PRIORITY = LangKey.of("Bans.Punishment.Error.RankPriority",
        GRAY + "You can't punish " + RED + GENERIC_USER + GRAY + "!");

    public static final LangKey PARDON_ERROR_RANK_PRIORITY = LangKey.of("Bans.Pardon.Error.RankPriority",
        GRAY + "You can't pardon " + GREEN + GENERIC_USER + GRAY + "!");

    public static final LangKey PUNISHMENT_ERROR_RANK_DURATION = LangKey.of("Bans.Punishment.Error.RankDuration",
        GRAY + "You can't punish for longer than " + RED + GENERIC_TIME + GRAY + "!");

    public static final LangKey PUNISHMENT_ERROR_IMMUNE = LangKey.of("Bans.Punishment.Error.Immune",
        "<! prefix:\"false\" !>" +
        RED + GENERIC_USER + GRAY + " can not be punished.");

    public static final LangKey PUNISHMENT_ERROR_NOT_BANNED = LangKey.of("Bans.Punishment.Error.NotBanned",
        "<! prefix:\"false\" !>" +
        RED + GENERIC_USER + GRAY + " is not banned.");

    public static final LangKey PUNISHMENT_ERROR_NOT_MUTED = LangKey.of("Bans.Punishment.Error.NotMuted",
        "<! prefix:\"false\" !>" +
        RED + GENERIC_USER + GRAY + " is not muted.");

    public static final LangKey PUNISHMENT_ERROR_NOT_WARNED = LangKey.of("Bans.Punishment.Error.NotWarned",
        "<! prefix:\"false\" !>" +
        RED + GENERIC_USER + GRAY + " does not have active warns.");

    public static final LangKey PUNISHMENT_ERROR_NOT_IP = LangKey.of("Bans.Punishment.Error.NotIP",
        "<! prefix:\"false\" !>" +
        RED + GENERIC_USER + " is not IP address!");

    public static final LangKey BAN_USER_PERMA_DONE = LangKey.of("Bans.Ban.User.Perma.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been permanently banned: " + RED + PUNISHMENT_REASON);

    public static final LangKey BAN_USER_PERMA_BROADCAST = LangKey.of("Bans.Ban.User.Perma.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " permanently banned " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey BAN_USER_TEMP_DONE = LangKey.of("Bans.Ban.User.Temp.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been banned for " + RED + PUNISHMENT_EXPIRES_IN + GRAY + ". Reason: " + RED + PUNISHMENT_REASON);

    public static final LangKey BAN_USER_TEMP_BROADCAST = LangKey.of("Bans.Ban.User.Temp.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " banned " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Duration: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRE_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey BAN_IP_PERMA_DONE = LangKey.of("Bans.Ban.IP.Perma.Done", "<! prefix:\"false\" !>" +
        GRAY + "IP " + RED + PUNISHMENT_USER + GRAY + " has been permanently banned: " + RED + PUNISHMENT_REASON);

    public static final LangKey BAN_IP_PERMA_BROADCAST = LangKey.of("Bans.Ban.IP.Perma.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " permanently banned IP " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey BAN_IP_TEMP_DONE = LangKey.of("Bans.Ban.IP.Temp.Done", "<! prefix:\"false\" !>" +
        GRAY + "IP " + RED + PUNISHMENT_USER + GRAY + " has been banned for " + RED + PUNISHMENT_EXPIRES_IN + GRAY + ". Reason: " + RED + PUNISHMENT_REASON);

    public static final LangKey BAN_IP_TEMP_BROADCAST = LangKey.of("Bans.Ban.IP.Temp.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " banned IP " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Duration: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRE_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey UNBAN_USER_DONE = LangKey.of("Bans.Unban.User.Done", "<! prefix:\"false\" !>" +
        "User unbanned: " + GREEN + PUNISHMENT_USER + GRAY + ".");

    public static final LangKey UNBAN_USER_BROADCAST = LangKey.of("Bans.Unban.User.Broadcast", "<! prefix:\"false\" !>" +
        GREEN + GENERIC_ADMIN + GRAY + " unbanned user: " + GREEN + PUNISHMENT_USER + GRAY + ".");

    public static final LangKey UNBAN_IP_DONE = LangKey.of("Bans.Unban.IP.Done", "<! prefix:\"false\" !>" +
        "IP unbanned: " + GREEN + PUNISHMENT_USER + GRAY + ".");

    public static final LangKey UNBAN_IP_BROADCAST = LangKey.of("Bans.Unban.IP.Broadcast", "<! prefix:\"false\" !>" +
        GREEN + GENERIC_ADMIN + GRAY + " unbanned IP: " + GREEN + PUNISHMENT_USER + GRAY + ".");

    public static final LangKey KICK_DONE = LangKey.of("Bans.Kick.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been kicked for " + RED + PUNISHMENT_REASON);

    public static final LangKey KICK_BROADCAST = LangKey.of("Bans.Kick.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " kicked " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_USER_PERMA_DONE = LangKey.of("Bans.Mute.User.Perma.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been permanently muted: " + RED + PUNISHMENT_REASON);
    ...
    public static final LangKey MUTE_USER_PERMA_NOTIFY = LangKey.of("Bans.Mute.User.Perma.Notify", "<! prefix:\"false\" !>" +
        ...
        + "<? show_text:\"&7By: &f" + PUNISHMENT_PUNISHER + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_USER_PERMA_BROADCAST = LangKey.of("Bans.Mute.User.Perma.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " permanently muted " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_USER_TEMP_DONE = LangKey.of("Bans.Mute.User.Temp.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been muted for " + RED + PUNISHMENT_EXPIRES_IN + GRAY + ". Reason: " + RED + PUNISHMENT_REASON);
    ...
    public static final LangKey MUTE_USER_TEMP_NOTIFY = LangKey.of("Bans.Mute.User.Temp.Notify", "<! prefix:\"false\" !>" +
        ...
        + "<? show_text:\"&7By: &f" + PUNISHMENT_PUNISHER + "<newline>&7Duration: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRE_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_USER_TEMP_BROADCAST = LangKey.of("Bans.Mute.User.Temp.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " muted " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Duration: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRE_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_IP_PERMA_DONE = LangKey.of("Bans.Mute.IP.Perma.Done", "<! prefix:\"false\" !>" +
        "IP " + RED + PUNISHMENT_USER + GRAY + " has been permanently muted: " + RED + PUNISHMENT_REASON);
    ...
    public static final LangKey MUTE_IP_PERMA_BROADCAST = LangKey.of("Bans.Mute.IP.Perma.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " permanently muted IP " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey MUTE_IP_TEMP_DONE = LangKey.of("Bans.Mute.IP.Temp.Done", "<! prefix:\"false\" !>" +
        "IP " + RED + PUNISHMENT_USER + GRAY + " has been muted for " + RED + PUNISHMENT_EXPIRES_IN + GRAY + ". Reason: " + RED + PUNISHMENT_REASON);
    ...
    public static final LangKey WARN_USER_TEMP_BROADCAST = LangKey.of("Bans.Warn.User.Temp.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " warned " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Duration: &f" + PUNISHMENT_EXPIRES_IN + "<newline>&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "<newline>&7Expires: &f" + PUNISHMENT_EXPIRE_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey WARN_USER_PERMA_DONE = LangKey.of("Bans.Warn.User.Perma.Done", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_USER + GRAY + " has been permanently warned for " + RED + PUNISHMENT_REASON);
    ...
    public static final LangKey WARN_USER_PERMA_BROADCAST = LangKey.of("Bans.Warn.User.Perma.Broadcast", "<! prefix:\"false\" !>" +
        RED + PUNISHMENT_PUNISHER + GRAY + " permanently warned " + RED + PUNISHMENT_USER + " "
        + "<? show_text:\"&7Reason: &f" + PUNISHMENT_REASON + "<newline>&7Date: &f" + PUNISHMENT_CREATION_DATE + "\" ?>" + ORANGE + "[Details]</>");

    public static final LangKey UNWARN_USER_DONE = LangKey.of("Bans.Unwarn.User.Done", "<! prefix:\"false\" !>" +
        GRAY + "Removed warn from " + GREEN + PUNISHMENT_USER + GRAY + ".");

    public static final LangKey UNWARN_USER_BROADCAST = LangKey.of("Bans.Unwarn.User.Broadcast", "<! prefix:\"false\" !>" +
        GREEN + PUNISHMENT_PUNISHER + GRAY + " removed warn from " + GREEN + PUNISHMENT_USER + GRAY + ".");
