...
import su.nightexpress.sunlight.command.mob.MobClearCommand;
...
public class Perms {
    ...
    public static final JPermission COMMAND_MOB_CLEAR  = forCommand(MobCommand.NAME, MobClearCommand.NAME);
    ...
    public static final JPermission COMMAND_NICK_COLORS = new JPermission(PREFIX_COMMAND + NickCommand.NAME + ".colors", "Allows to use colors in custom nicknames.");
    ...
    static {
        ...
        COMMAND.addChildren(
            ...
            COMMAND_MOB, COMMAND_MOB_KILL, COMMAND_MOB_CLEAR, COMMAND_MOB_SPAWN,
