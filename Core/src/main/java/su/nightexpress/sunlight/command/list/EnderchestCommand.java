...
public class EnderchestCommand {
    ...
    public static final String NODE_CLEAR  = "enderchest_clear";
    public static final String NODE_COPY   = "enderchest_copy";
    public static final String NODE_FILL   = "enderchest_fill";
    public static final String NODE_OPEN   = "enderchest_open";
    public static final String NODE_REPAIR = "enderchest_repair";
    ...
    public static void load(@NotNull SunLightPlugin plugin) {
        ...
        CommandRegistry.addTemplate("enderchest", CommandTemplate.group(new String[]{"enderchest", "echest"},
            "Enderchest commands.",
            CommandPerms.PREFIX + "enderchest",
        ...
        CommandRegistry.addTemplate("ec", CommandTemplate.direct(new String[]{"ec", "endersee"}, NODE_OPEN));
    }
    ...
    public static DirectNodeBuilder builderClear(@NotNull SunLightPlugin plugin, @NotNull CommandTemplate template, @NotNull FileConfig config) {
        return DirectNode.builder(plugin, template.getAliases())
            .description(Lang.COMMAND_ENDERCHEST_CLEAR_DESC)
            .permission(CommandPerms.ENDERCHEST_CLEAR)
            .withArgument(ArgumentTypes.playerName(CommandArguments.PLAYER).permission(CommandPerms.ENDERCHEST_CLEAR_OTHERS))
            .withFlag(CommandFlags.silent().permission(CommandPerms.ENDERCHEST_CLEAR_OTHERS))
    ...
    public static boolean executeClear(@NotNull SunLightPlugin plugin, @NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        if (context.getSender() != target) {
            context.send(Lang.COMMAND_ENDERCHEST_CLEAR_DONE_OTHERS.getMessage()
                .replace(Placeholders.forPlayer(target))
            );
        }

        if (!arguments.hasFlag(CommandFlags.SILENT)) {
            Lang.COMMAND_ENDERCHEST_CLEAR_DONE_NOTIFY.getMessage().send(target);
        }
        return true;
    }
    ...
    public static DirectNodeBuilder builderCopy(@NotNull SunLightPlugin plugin, @NotNull CommandTemplate template, @NotNull FileConfig config) {
        return DirectNode.builder(plugin, template.getAliases())
            .description(Lang.COMMAND_ENDERCHEST_COPY_DESC)
            .permission(CommandPerms.ENDERCHEST_COPY)
            .withArgument(ArgumentTypes.playerName(CommandArguments.PLAYER).required())
            .withArgument(ArgumentTypes.playerName(CommandArguments.TARGET).permission(CommandPerms.ENDERCHEST_COPY_OTHERS))
    ...
    public static boolean executeCopy(@NotNull SunLightPlugin plugin, @NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        Inventory invFrom = plugin.getSunNMS().getPlayerEnderChest(source);
        Inventory invTo = plugin.getSunNMS().getPlayerEnderChest(target);
        ...
        if (context.getSender() == target) {
            context.send(Lang.COMMAND_ENDERCHEST_COPY_DONE_EXECUTOR.getMessage()
                .replace(Placeholders.forPlayer(source))
            );
        }
        else {
            context.send(Lang.COMMAND_ENDERCHEST_COPY_DONE_OTHERS.getMessage()
    ...
    public static DirectNodeBuilder builderFill(@NotNull SunLightPlugin plugin, @NotNull CommandTemplate template, @NotNull FileConfig config) {
        return DirectNode.builder(plugin, template.getAliases())
            .description(Lang.COMMAND_ENDERCHEST_FILL_DESC)
            .permission(CommandPerms.ENDERCHEST_FILL)
            .withArgument(ArgumentTypes.playerName(CommandArguments.PLAYER).required())
    ...
    public static boolean executeFill(@NotNull SunLightPlugin plugin, @NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        context.send(Lang.COMMAND_ENDERCHEST_FILL_DONE_EXECUTOR.getMessage()
            .replace(Placeholders.forPlayer(target))
    ...
    public static DirectNodeBuilder builderOpen(@NotNull SunLightPlugin plugin, @NotNull CommandTemplate template, @NotNull FileConfig config) {
        return DirectNode.builder(plugin, template.getAliases())
            .playerOnly()
            .description(Lang.COMMAND_ENDERCHEST_OPEN_DESC)
            .permission(CommandPerms.ENDERCHEST_OPEN)
            .withArgument(ArgumentTypes.playerName(CommandArguments.PLAYER).permission(CommandPerms.ENDERCHEST_OPEN_OTHERS))
    ...
    public static boolean executeOpen(@NotNull SunLightPlugin plugin, @NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        return context.sendSuccess(Lang.COMMAND_ENDERCHEST_OPEN_DONE_EXECUTOR.getMessage().replace(Placeholders.forPlayer(target)));
    }
    ...
    public static DirectNodeBuilder builderRepair(@NotNull SunLightPlugin plugin, @NotNull CommandTemplate template, @NotNull FileConfig config) {
        return DirectNode.builder(plugin, template.getAliases())
            .description(Lang.COMMAND_ENDERCHEST_REPAIR_DESC)
            .permission(CommandPerms.ENDERCHEST_REPAIR)
            .withArgument(ArgumentTypes.playerName(CommandArguments.PLAYER).permission(CommandPerms.ENDERCHEST_REPAIR_OTHERS))
            .withFlag(CommandFlags.silent().permission(CommandPerms.ENDERCHEST_REPAIR_OTHERS))
    ...
    public static boolean executeRepair(@NotNull SunLightPlugin plugin, @NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        plugin.getSunNMS().getPlayerEnderChest(target).forEach(SunUtils::repairItem);
        if (!target.isOnline()) target.saveData();

        if (context.getSender() != target) {
            context.send(Lang.COMMAND_ENDERCHEST_REPAIR_TARGET.getMessage().replace(Placeholders.forPlayer(target)));
        }

        if (!arguments.hasFlag(CommandFlags.SILENT)) {
            Lang.COMMAND_ENDERCHEST_REPAIR_NOTIFY.getMessage().send(target);
        }
