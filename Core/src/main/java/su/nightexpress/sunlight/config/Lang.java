...
public class Lang extends EngineLang implements LangColors {
    ...
    public static final LangKey COMMAND_AIR_ADD_TARGET    = LangKey.of("Command.Air.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_AIR_REMOVE_TARGET = LangKey.of("Command.Air.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_AIR_SET_TARGET    = LangKey.of("Command.Air.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ANVIL_TARGET = LangKey.of("Command.Anvil.Target", LIGHT_YELLOW + "Opened portable anvil for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_BACK_TARGET        = LangKey.of("Command.Back.Target", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " teleported to his previous location.");
    ...
    @Deprecated public static final LangKey Command_Broadcast_Format    = new LangKey("Command.Broadcast.Format", "{message: ~prefix: false;}&6[&eBroadcast&6] &c%msg%");
    ...
    public static final LangKey COMMAND_DEATH_BACK_TARGET        = LangKey.of("Command.DeathBack.Target", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " teleported to his death location.");
    ...
    public static final LangKey COMMAND_DISPOSAL_TARGET = LangKey.of("Command.Disposal.Target", LIGHT_YELLOW + "Opened disposal for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_DIMENSION_TARGET = LangKey.of("Command.Dimension.Target", LIGHT_YELLOW + "Teleported " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to the " + ORANGE + Placeholders.GENERIC_WORLD + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENCHANT_ENCHANTED_TARGET = LangKey.of("Command.Enchant.Enchanted.Target",
        "<! sound:\"" + Sound.BLOCK_ENCHANTMENT_TABLE_USE.name() + "\" !>" +
            ...
            ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " slot!");
    ...
    public static final LangKey COMMAND_ENCHANTING_TARGET = LangKey.of("Command.Enchanting.Target", LIGHT_YELLOW + "Opened enchanting table for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_EXP_ADD_TARGET    = LangKey.of("Command.Exp.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " exp/levels to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". XP: " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + ", Level: " + ORANGE + Placeholders.GENERIC_LEVEL + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_EXP_REMOVE_TARGET = LangKey.of("Command.Exp.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " exp/levels from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". XP: " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + ", Level: " + ORANGE + Placeholders.GENERIC_LEVEL + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_EXP_SET_TARGET    = LangKey.of("Command.Exp.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " exp/levels for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". XP: " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + ", Level" + ORANGE + Placeholders.GENERIC_LEVEL + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENDERCHEST_CLEAR_DONE_TARGET = LangKey.of("Command.Enderchest.Clear.Done.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Cleared " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s ender chest!");
    ...
    public static final LangKey COMMAND_ENDERCHEST_COPY_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Copy.Done.Executor", "<! sound:\"" + Sound.ITEM_ARMOR_EQUIP_LEATHER.name() + "\" !>" + LIGHT_YELLOW + "Copied " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s ender chest.");
    ...
    public static final LangKey COMMAND_ENDERCHEST_FILL_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Fill.Done.Executor", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "Filled " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s ender chest with " + ORANGE + Placeholders.GENERIC_ITEM + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENDERCHEST_OPEN_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Open.Done.Executor", "<! sound:\"" + Sound.BLOCK_CHEST_OPEN.name() + "\" !>" + LIGHT_YELLOW + "Opened " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s ender chest.");
    ...
    public static final LangKey COMMAND_ENDERCHEST_REPAIR_TARGET = LangKey.of("Command.Enderchest.Repair.Target", "<! sound:\"" + Sound.BLOCK_ANVIL_USE.name() + "\" !>" + LIGHT_YELLOW + "Repaired all items in " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s ender chest!");
    ...
    public static final LangKey COMMAND_EXTINGUISH_TARGET = LangKey.of("Command.Extinguish.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " have been extinguished.");
    ...
    public static final LangKey COMMAND_FEED_TARGET = LangKey.of("Command.Feed.Done.Others", "<! sound:\"" + Sound.ENTITY_GENERIC_EAT.name() + "\" !>" + LIGHT_YELLOW + "Restored " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s food level!");
    ...
    public static final LangKey COMMAND_FLY_TARGET = LangKey.of("Command.Fly.Target", LIGHT_YELLOW + "Set flying for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_FIRE_ADD_TARGET    = LangKey.of("Command.Fire.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    public static final LangKey COMMAND_FIRE_REMOVE_TARGET = LangKey.of("Command.Fire.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    public static final LangKey COMMAND_FIRE_SET_TARGET    = LangKey.of("Command.Fire.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    ...
    public static final LangKey COMMAND_FOOD_ADD_TARGET    = LangKey.of("Command.Food.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_FOOD_REMOVE_TARGET = LangKey.of("Command.Food.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_FOOD_SET_TARGET    = LangKey.of("Command.Food.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_FOOD_GOD_TARGET = LangKey.of("Command.FoodGod.Target", LIGHT_YELLOW + "Set Food God for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_GAME_MODE_TARGET = LangKey.of("Command.GameMode.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " game mode for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_GOD_TOGGLE_TARGET     = LangKey.of("Command.God.Toggle.Target", LIGHT_YELLOW + "Set God Mode " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_HEAL_TARGET = LangKey.of("Command.Heal.Target", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " has been healed.");
    ...
    public static final LangKey COMMAND_IGNORE_ADD_DONE             = LangKey.of("Command.Ignore.Add.Done", LIGHT_YELLOW + "Player " + RED + Placeholders.Player.NAME + LIGHT_YELLOW + " added to the blacklist. You can change settings or unblock him using " + RED + "/" + IgnoreCommand.NAME + " list");
    ...
    public static final LangKey COMMAND_IGNORE_REMOVE_DONE          = LangKey.of("Command.Ignore.Remove.Done", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " has ben removed from the blacklist.");
    ...
    public static final LangKey COMMAND_INVENTORY_CLEAR_DONE_TARGET = LangKey.of("Command.Inventory.Clear.Done.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Cleared " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s inventory!");
    ...
    public static final LangKey COMMAND_INVENTORY_COPY_DONE_NOTIFY = LangKey.of("Command.Inventory.Copy.Done.Notify", "<! sound:\"" + Sound.ITEM_ARMOR_EQUIP_LEATHER.name() + "\" !>" + LIGHT_YELLOW + "Copied " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s inventory.");
    ...
    public static final LangKey COMMAND_INVENTORY_FILL_DONE  = LangKey.of("Command.Inventory.Fill.Done", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "Filled " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s inventory with " + ORANGE + Placeholders.GENERIC_ITEM + LIGHT_YELLOW  +".");
    ...
    public static final LangKey COMMAND_INVENTORY_OPEN_DONE  = LangKey.of("Command.Inventory.Open.Done", "<! sound:\"" + Sound.BLOCK_CHEST_OPEN.name() + "\" !>" + LIGHT_YELLOW + "Opened " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s inventory.");
    ...
    public static final LangKey COMMAND_INVENTORY_REPAIR_TARGET = LangKey.of("Command.Inventory.Repair.Target", "<! sound:\"" + Sound.BLOCK_ANVIL_USE.name() + "\" !>" + LIGHT_YELLOW + "Repaired all items in " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s inventory!");
    ...
    public static final LangKey COMMAND_ITEM_GIVE_DONE   = LangKey.of("Command.Item.Give.Done", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "You gave " + ORANGE + "x" + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " of " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "!");
    ...
    public static final LangKey COMMAND_ITEM_TAKE_DONE             = LangKey.of("Command.Item.Take.Done", "<! sound:\"" + Sound.ENTITY_GLOW_ITEM_FRAME_REMOVE_ITEM.name() + "\" !>" + LIGHT_YELLOW + "You took " + ORANGE + "x" +  Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " of " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "!");
    ...
    public static final LangKey COMMAND_MOB_KILL_DONE       = LangKey.of("Command.Mob.Kill.Done",
        "<! prefix:\"false\" sound:\"" + Sound.ENTITY_ZOMBIE_DEATH.name() + "\" !>" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Mobs Kill Details:" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "▪ " + ORANGE + Placeholders.GENERIC_TYPE + ": " + LIGHT_YELLOW + Placeholders.GENERIC_AMOUNT +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Total " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + " mobs killed in " + ORANGE + Placeholders.GENERIC_WORLD + LIGHT_YELLOW + " within " + ORANGE + Placeholders.GENERIC_RADIUS + LIGHT_YELLOW + " blocks." +
            "\n" + LIGHT_YELLOW
    );
    ...
    public static final LangKey COMMAND_NICK_CLEAR_TARGET           = LangKey.of("Command.Nick.Clear.Target", LIGHT_YELLOW + "Removed custom nick for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_NICK_SET_TARGET             = LangKey.of("Command.Nick.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_NAME + LIGHT_YELLOW + " as custom nick for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_NO_PHANTOM_TOGGLE_TARGET = LangKey.of("Command.NoPhantom.Toggle.Target", LIGHT_YELLOW + "Set Anti-Phantom mode " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SKULL_DONE  = LangKey.of("Command.Skull.Done", LIGHT_YELLOW + "You got " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "'s head.");
    ...
    public static final LangKey COMMAND_SPEED_DESC             = LangKey.of("Command.Speed.Desc", "Change [player's] fly/walk speed.");
    public static final LangKey COMMAND_SPEED_USAGE            = LangKey.of("Command.Speed.Usage", "<speed> [player] [-fly] [-s]");
    public static final LangKey COMMAND_SPEED_DONE_WALK_NOTIFY = LangKey.of("Command.Speed.Done.Walk.Notify", LIGHT_YELLOW + "Your walk speed has been set to " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_SPEED_DONE_WALK_TARGET = LangKey.of("Command.Speed.Done.Walk.Target", "Set walk speed to " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_SPEED_DONE_FLY_NOTIFY  = LangKey.of("Command.Speed.Done.Fly.Notify", LIGHT_YELLOW + "Your fly speed has been set to " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_SPEED_DONE_FLY_TARGET  = LangKey.of("Command.Speed.Done.Fly.Target", "Set fly speed to " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " for " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SUDO_DONE_COMMAND = LangKey.of("Command.Sudo.Done.Command", LIGHT_YELLOW + "Forced " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to perform: " + ORANGE + "/" + Placeholders.GENERIC_COMMAND + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_SUDO_DONE_CHAT    = LangKey.of("Command.Sudo.Done.Chat", LIGHT_YELLOW + "Forced " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to write: " + ORANGE + Placeholders.GENERIC_COMMAND + LIGHT_YELLOW + ".");

    public static final LangKey COMMAND_SUICIDE_DESC = LangKey.of("Command.Suicide.Desc", "Commit suicide.");
    public static final LangKey COMMAND_SUICIDE_DONE = LangKey.of("Command.Suicide.Done", "<! prefix:\"false\" !>" + ORANGE + Placeholders.Player.DISPLAY_NAME + LIGHT_YELLOW + " commited suicide.");
    ...
    public static final LangKey COMMAND_TELEPORT_ERROR_REQUESTS_DISABLED = LangKey.of("Command.Teleport.Error.Requests.Disabled", "<! sound:\"" + Sound.ENTITY_VILLAGER_NO.name() + "\" !>" + RED + "You can't send teleport requests to " + ORANGE + Placeholders.Player.NAME + RED + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_ACCEPT_NOTIFY_SENDER = LangKey.of("Command.Teleport.Accept.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You accepted teleport request from " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "!");
    public static final LangKey COMMAND_TELEPORT_ACCEPT_NOTIFY_TARGET = LangKey.of("Command.Teleport.Accept.Notify.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " accepted your teleport request!");
    ...
    public static final LangKey COMMAND_TELEPORT_DECLINE_NOTIFY_SENDER = LangKey.of("Command.Teleport.Decline.Notify.Sender", "<! sound:\"" + Sound.ENTITY_VILLAGER_NO.name() + "\" !>" + LIGHT_YELLOW + "You declined teleport request of " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_DECLINE_NOTIFY_TARGET = LangKey.of("Command.Teleport.Decline.Notify.Target", "<! sound:\"" + Sound.ENTITY_VILLAGER_NO.name() + "\" !>" + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " declines your teleport request.");
    ...
    public static final LangKey COMMAND_TELEPORT_INVITE_NOTIFY_SENDER = LangKey.of("Command.Teleport.Invite.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" + LIGHT_YELLOW + "Sent teleport request to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_INVITE_NOTIFY_TARGET = LangKey.of("Command.Teleport.Invite.Notify.Target",
        "<! prefix:\"false\" sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" +
            ...
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " invites you to teleport to him." +
            "\n" + LIGHT_YELLOW + "Type " + GREEN + "/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.Player.NAME + LIGHT_YELLOW + " to accept and teleport." +
            "\n" + LIGHT_YELLOW + "or " + RED + "/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.Player.NAME + LIGHT_YELLOW + " to decline." +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "             <? show_text:\"" + GRAY + "You will be teleported to " + GREEN + Placeholders.Player.NAME + GRAY + ".\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.Player.NAME + "\"?>" + GREEN + "&l[Accept]</> " + LIGHT_YELLOW + "        <? show_text:\"" + GRAY + "You won't be teleported to " + RED + Placeholders.Player.NAME + GRAY + ".\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.Player.NAME + "\"?>" + RED + "&l[Decline]</>" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW);
    ...
    public static final LangKey COMMAND_TELEPORT_LOCATION_DONE_TARGET = LangKey.of("Command.Teleport.Location.Done.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " teleported to " + ORANGE + Placeholders.Location.X + ", " + Placeholders.Location.Y + ", " + Placeholders.Location.Z + LIGHT_YELLOW + " in " + ORANGE + Placeholders.Location.WORLD + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_LOCATION_DONE_NOTIFY = LangKey.of("Command.Teleport.Location.Done.Notify", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You were teleported to " + ORANGE + Placeholders.Location.X + ", " + Placeholders.Location.Y + ", " + Placeholders.Location.Z + LIGHT_YELLOW + " in " + ORANGE + Placeholders.Location.WORLD + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_REQUEST_NOTIFY_SENDER = LangKey.of("Command.Teleport.Request.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" + LIGHT_YELLOW + "Sent teleport request to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_REQUEST_NOTIFY_TARGET = LangKey.of("Command.Teleport.Request.Notify.Target",
        "<! prefix:\"false\" sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" +
            ...
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " wants to be teleported to you." +
            "\n" + LIGHT_YELLOW + "Type " + GREEN + "/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.Player.NAME + LIGHT_YELLOW + " to accept and teleport him." +
            "\n" + LIGHT_YELLOW + "or " + RED + "/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.Player.NAME + LIGHT_YELLOW + " to decline." +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "             <? show_text:\"" + GREEN + Placeholders.Player.NAME + GRAY + " will be teleported to you.\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.Player.NAME + "\"?>" + GREEN + "&l[Accept]</> " + LIGHT_YELLOW + "        <? show_text:\"" + RED + Placeholders.Player.NAME + GRAY + " won't be teleported to you.\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.Player.NAME + "\"?>" + RED + "&l[Decline]</>" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW);
    ...
    public static final LangKey COMMAND_TELEPORT_TOGGLE_TARGET = LangKey.of("Command.Teleport.Toggle.Target", LIGHT_YELLOW + "Teleport requests " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_SUMMON_TARGET = LangKey.of("Command.Teleport.Summon.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Summoned " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " to your location.");
    public static final LangKey COMMAND_TELEPORT_SUMMON_NOTIFY = LangKey.of("Command.Teleport.Summon.Notify", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You were summoned by " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_TO_DONE        = LangKey.of("Command.Teleport.To.Done", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Teleporting to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_SEND_NOTIFY = LangKey.of("Command.Teleport.Send.Notify", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You have been teleported to " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_TOP_TARGET = LangKey.of("Command.Teleport.Top.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + " teleported on the highest block.");
    ...
    public static final LangKey COMMAND_TIME_PERSONAL_TARGET  = LangKey.of("Command.Time.Personal.Target", LIGHT_YELLOW + "Set time to " + ORANGE + Placeholders.GENERIC_TIME + GRAY + " (" + Placeholders.GENERIC_TOTAL + " ticks)" + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SMITE_TARGET = LangKey.of("Command.Smite.Target", LIGHT_YELLOW + "Smited " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + "!");
    ...
    public static final LangKey COMMAND_VANISH_TARGET = LangKey.of("Command.Vanish.Target", LIGHT_YELLOW + "Set vanish " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_WORKBENCH_TARGET = LangKey.of("Command.Workbench.Target", LIGHT_YELLOW + "Opened portable workbench for " + ORANGE + Placeholders.Player.NAME + LIGHT_YELLOW + ".");
    ...
    @Deprecated public static final LangKey OTHER_PLAYER_DATA_ERROR_READ = new LangKey("Other.PlayerData.Error.Read", "{message: ~sound: BLOCK_ANVIL_PLACE;}&cAn unexpected error occured while trying to read player data file.");
    @Deprecated public static final LangKey OTHER_PLAYER_DATA_ERROR_WRITE = new LangKey("Other.PlayerData.Error.Write", "{message: ~sound: BLOCK_ANVIL_PLACE;}&cAn unexpected error occured while trying to save player data file.");

    public static final LangKey OTHER_MENU_LIST_DELIMITER = new LangKey("Other.Menu.List_Delimiter", "&a▸ ");
    @Deprecated public static final LangKey Other_Free                = new LangKey("Other.Free", "&aFree");
    @Deprecated public static final LangKey Other_On          = new LangKey("Other.On", "&aON");
    @Deprecated public static final LangKey Other_Off      = new LangKey("Other.Off", "&cOFF");
    ...
    @Deprecated public static final LangKey Error_InvalidName = new LangKey("Error.InvalidName", "{message: ~prefix: false;}&cInvalid name: &e%name%&c. Contains forbidden characters.");
    @Deprecated public static final LangKey Error_Material            = new LangKey("Error.Material", "{message: ~prefix: false;}&cInvalid material!");
