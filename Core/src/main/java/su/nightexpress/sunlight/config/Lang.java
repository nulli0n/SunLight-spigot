...
public class Lang extends EngineLang {
    ...
    public static final LangKey COMMAND_AIR_ADD_TARGET    = LangKey.of("Command.Air.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_AIR_REMOVE_TARGET = LangKey.of("Command.Air.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_AIR_SET_TARGET    = LangKey.of("Command.Air.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " air ticks for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New air ticks: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ANVIL_TARGET = LangKey.of("Command.Anvil.Target", LIGHT_YELLOW + "Opened portable anvil for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_BACK_TARGET        = LangKey.of("Command.Back.Target", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " teleported to his previous location.");
    ...
    public static final LangKey COMMAND_DEATH_BACK_TARGET        = LangKey.of("Command.DeathBack.Target", LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " teleported to his death location.");
    ...
    public static final LangKey COMMAND_DISPOSAL_TARGET = LangKey.of("Command.Disposal.Target", LIGHT_YELLOW + "Opened disposal for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_DIMENSION_TARGET = LangKey.of("Command.Dimension.Target", LIGHT_YELLOW + "Teleported " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to the " + ORANGE + Placeholders.GENERIC_WORLD + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENCHANT_ENCHANTED_TARGET = LangKey.of("Command.Enchant.Enchanted.Target",
        "<! sound:\"" + Sound.BLOCK_ENCHANTMENT_TABLE_USE.name() + "\" !>" +
            ...
            ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " slot!");
    ...
    public static final LangKey COMMAND_EXP_REMOVE_TARGET = LangKey.of("Command.Exp.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " exp/levels from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". XP: " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + ", Level: " + ORANGE + Placeholders.GENERIC_LEVEL + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_EXP_SET_TARGET    = LangKey.of("Command.Exp.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " exp/levels for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". XP: " + ORANGE + Placeholders.GENERIC_TOTAL + LIGHT_YELLOW + ", Level" + ORANGE + Placeholders.GENERIC_LEVEL + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENDERCHEST_CLEAR_DONE_TARGET = LangKey.of("Command.Enderchest.Clear.Done.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Cleared " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s ender chest!");
    ...
    public static final LangKey COMMAND_ENDERCHEST_COPY_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Copy.Done.Executor", "<! sound:\"" + Sound.ITEM_ARMOR_EQUIP_LEATHER.name() + "\" !>" + LIGHT_YELLOW + "Copied " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s ender chest.");
    ...
    public static final LangKey COMMAND_ENDERCHEST_FILL_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Fill.Done.Executor", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "Filled " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s ender chest with " + ORANGE + Placeholders.GENERIC_ITEM + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_ENDERCHEST_OPEN_DONE_EXECUTOR = LangKey.of("Command.Enderchest.Open.Done.Executor", "<! sound:\"" + Sound.BLOCK_CHEST_OPEN.name() + "\" !>" + LIGHT_YELLOW + "Opened " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s ender chest.");
    ...
    public static final LangKey COMMAND_ENDERCHEST_REPAIR_TARGET = LangKey.of("Command.Enderchest.Repair.Target", "<! sound:\"" + Sound.BLOCK_ANVIL_USE.name() + "\" !>" + LIGHT_YELLOW + "Repaired all items in " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s ender chest!");
    ...
    public static final LangKey COMMAND_EXTINGUISH_TARGET = LangKey.of("Command.Extinguish.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " have been extinguished.");
    ...
    public static final LangKey COMMAND_FEED_TARGET = LangKey.of("Command.Feed.Done.Others", "<! sound:\"" + Sound.ENTITY_GENERIC_EAT.name() + "\" !>" + LIGHT_YELLOW + "Restored " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s food level!");
    ...
    public static final LangKey COMMAND_FLY_TARGET = LangKey.of("Command.Fly.Target", LIGHT_YELLOW + "Set flying for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_FIRE_ADD_TARGET    = LangKey.of("Command.Fire.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    public static final LangKey COMMAND_FIRE_REMOVE_TARGET = LangKey.of("Command.Fire.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    public static final LangKey COMMAND_FIRE_SET_TARGET    = LangKey.of("Command.Fire.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " fire ticks for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New fire ticks: " + ORANGE + Placeholders.GENERIC_TOTAL + GRAY + " (" + Placeholders.GENERIC_TIME + "s)");
    ...
    public static final LangKey COMMAND_FOOD_ADD_TARGET    = LangKey.of("Command.Food.Give.Target", LIGHT_YELLOW + "Added " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_FOOD_REMOVE_TARGET = LangKey.of("Command.Food.Take.Target", LIGHT_YELLOW + "Removed " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_FOOD_SET_TARGET    = LangKey.of("Command.Food.Set.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " food points for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ". New food level: " + ORANGE + Placeholders.GENERIC_CURRENT + LIGHT_YELLOW + "/" + ORANGE + Placeholders.GENERIC_MAX + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_GAME_MODE_TARGET = LangKey.of("Command.GameMode.Target", LIGHT_YELLOW + "Set " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " game mode for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_INVENTORY_CLEAR_DONE_TARGET = LangKey.of("Command.Inventory.Clear.Done.Target", "<! sound:\"" + Sound.BLOCK_FIRE_EXTINGUISH.name() + "\" !>" + LIGHT_YELLOW + "Cleared " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s inventory!");
    ...
    public static final LangKey COMMAND_INVENTORY_COPY_DONE_NOTIFY = LangKey.of("Command.Inventory.Copy.Done.Notify", "<! sound:\"" + Sound.ITEM_ARMOR_EQUIP_LEATHER.name() + "\" !>" + LIGHT_YELLOW + "Copied " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s inventory.");
    ...
    public static final LangKey COMMAND_INVENTORY_FILL_DONE  = LangKey.of("Command.Inventory.Fill.Done", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "Filled " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s inventory with " + ORANGE + Placeholders.GENERIC_ITEM + LIGHT_YELLOW  +".");
    ...
    public static final LangKey COMMAND_INVENTORY_OPEN_DONE  = LangKey.of("Command.Inventory.Open.Done", "<! sound:\"" + Sound.BLOCK_CHEST_OPEN.name() + "\" !>" + LIGHT_YELLOW + "Opened " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s inventory.");
    ...
    public static final LangKey COMMAND_INVENTORY_REPAIR_TARGET = LangKey.of("Command.Inventory.Repair.Target", "<! sound:\"" + Sound.BLOCK_ANVIL_USE.name() + "\" !>" + LIGHT_YELLOW + "Repaired all items in " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "'s inventory!");
    ...
    public static final LangKey COMMAND_ITEM_GIVE_DONE   = LangKey.of("Command.Item.Give.Done", "<! sound:\"" + Sound.ENTITY_ITEM_PICKUP.name() + "\" !>" + LIGHT_YELLOW + "You gave " + ORANGE + "x" + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " of " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "!");
    ...
    public static final LangKey COMMAND_ITEM_TAKE_DONE             = LangKey.of("Command.Item.Take.Done", "<! sound:\"" + Sound.ENTITY_GLOW_ITEM_FRAME_REMOVE_ITEM.name() + "\" !>" + LIGHT_YELLOW + "You took " + ORANGE + "x" +  Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " of " + ORANGE + Placeholders.GENERIC_TYPE + LIGHT_YELLOW + " from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "!");
    ...
    public static final LangKey COMMAND_NICK_CLEAR_TARGET           = LangKey.of("Command.Nick.Clear.Target", LIGHT_YELLOW + "Removed custom nick for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SPEED_DONE_WALK_TARGET = LangKey.of("Command.Speed.Done.Walk.Target", "Set walk speed to " + ORANGE + Placeholders.GENERIC_AMOUNT + LIGHT_YELLOW + " for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_SUDO_DONE_COMMAND = LangKey.of("Command.Sudo.Done.Command", LIGHT_YELLOW + "Forced " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to perform: " + ORANGE + "/" + Placeholders.GENERIC_COMMAND + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_SUDO_DONE_CHAT    = LangKey.of("Command.Sudo.Done.Chat", LIGHT_YELLOW + "Forced " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to write: " + ORANGE + Placeholders.GENERIC_COMMAND + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_ACCEPT_NOTIFY_SENDER = LangKey.of("Command.Teleport.Accept.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You accepted teleport request from " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + "!");
    public static final LangKey COMMAND_TELEPORT_ACCEPT_NOTIFY_TARGET = LangKey.of("Command.Teleport.Accept.Notify.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " accepted your teleport request!");
    ...
    public static final LangKey COMMAND_TELEPORT_DECLINE_NOTIFY_SENDER = LangKey.of("Command.Teleport.Decline.Notify.Sender", "<! sound:\"" + Sound.ENTITY_VILLAGER_NO.name() + "\" !>" + LIGHT_YELLOW + "You declined teleport request of " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_DECLINE_NOTIFY_TARGET = LangKey.of("Command.Teleport.Decline.Notify.Target", "<! sound:\"" + Sound.ENTITY_VILLAGER_NO.name() + "\" !>" + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " declines your teleport request.");
    ...
    public static final LangKey COMMAND_TELEPORT_INVITE_NOTIFY_SENDER = LangKey.of("Command.Teleport.Invite.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" + LIGHT_YELLOW + "Sent teleport request to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_INVITE_NOTIFY_TARGET = LangKey.of("Command.Teleport.Invite.Notify.Target",
        "<! prefix:\"false\" sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" +
            ...
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " invites you to teleport to him." +
            ...
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "             <? show_text:\"" + GRAY + "You will be teleported to " + GREEN + Placeholders.PLAYER_NAME + GRAY + ".\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.PLAYER_NAME + "\"?>" + GREEN + "&l[Accept]</> " + LIGHT_YELLOW + "        <? show_text:\"" + GRAY + "You won't be teleported to " + RED + Placeholders.PLAYER_NAME + GRAY + ".\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.PLAYER_NAME + "\"?>" + RED + "&l[Decline]</>" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW);
    ...
    public static final LangKey COMMAND_TELEPORT_LOCATION_DONE_TARGET = LangKey.of("Command.Teleport.Location.Done.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " teleported to " + ORANGE + Placeholders.LOCATION_X + ", " + Placeholders.LOCATION_Y + ", " + Placeholders.LOCATION_Z + LIGHT_YELLOW + " in " + ORANGE + Placeholders.LOCATION_WORLD + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_REQUEST_NOTIFY_SENDER = LangKey.of("Command.Teleport.Request.Notify.Sender", "<! sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" + LIGHT_YELLOW + "Sent teleport request to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    public static final LangKey COMMAND_TELEPORT_REQUEST_NOTIFY_TARGET = LangKey.of("Command.Teleport.Request.Notify.Target",
        "<! prefix:\"false\" sound:\"" + Sound.ENTITY_ENDER_PEARL_THROW.name() + "\" !>" +
            ...
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " wants to be teleported to you." +
            ...
            "\n" + LIGHT_YELLOW + "or " + RED + "/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to decline." +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW + "             <? show_text:\"" + GREEN + Placeholders.PLAYER_NAME + GRAY + " will be teleported to you.\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportAcceptCommand.NAME + " " + Placeholders.PLAYER_NAME + "\"?>" + GREEN + "&l[Accept]</> " + LIGHT_YELLOW + "        <? show_text:\"" + RED + Placeholders.PLAYER_NAME + GRAY + " won't be teleported to you.\" run_command:\"/" + TeleportCommand.NAME + " " + TeleportDeclineCommand.NAME + " " + Placeholders.PLAYER_NAME + "\"?>" + RED + "&l[Decline]</>" +
            "\n" + LIGHT_YELLOW +
            "\n" + LIGHT_YELLOW);
    ...
    public static final LangKey COMMAND_TELEPORT_TOGGLE_TARGET = LangKey.of("Command.Teleport.Toggle.Target", LIGHT_YELLOW + "Teleport requests " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_SUMMON_TARGET = LangKey.of("Command.Teleport.Summon.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Summoned " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " to your location.");
    public static final LangKey COMMAND_TELEPORT_SUMMON_NOTIFY = LangKey.of("Command.Teleport.Summon.Notify", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You were summoned by " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_TO_DONE        = LangKey.of("Command.Teleport.To.Done", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Teleporting to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_SEND_NOTIFY = LangKey.of("Command.Teleport.Send.Notify", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "You have been teleported to " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_TELEPORT_TOP_TARGET = LangKey.of("Command.Teleport.Top.Target", "<! sound:\"" + Sound.ENTITY_ENDERMAN_TELEPORT.name() + "\" !>" + LIGHT_YELLOW + "Player " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + " teleported on the highest block.");
    ...
    public static final LangKey COMMAND_TIME_PERSONAL_TARGET  = LangKey.of("Command.Time.Personal.Target", LIGHT_YELLOW + "Set time to " + ORANGE + Placeholders.GENERIC_TIME + GRAY + " (" + Placeholders.GENERIC_TOTAL + " ticks)" + LIGHT_YELLOW + " for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_VANISH_TARGET = LangKey.of("Command.Vanish.Target", LIGHT_YELLOW + "Set vanish " + ORANGE + Placeholders.GENERIC_STATE + LIGHT_YELLOW + " for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    public static final LangKey COMMAND_WORKBENCH_TARGET = LangKey.of("Command.Workbench.Target", LIGHT_YELLOW + "Opened portable workbench for " + ORANGE + Placeholders.PLAYER_NAME + LIGHT_YELLOW + ".");
    ...
    @Deprecated public static final LangKey Error_InvalidName = new LangKey("Error.InvalidName", NO_PREFIX + "&cInvalid name: &e%name%&c. Contains forbidden characters.");
    @Deprecated public static final LangKey Error_Material            = new LangKey("Error.Material", NO_PREFIX + "&cInvalid material!");
    ...
    public static final LangKey             Error_Self                = new LangKey("Error.Self", NO_PREFIX + "&cUnable to apply on self!");
